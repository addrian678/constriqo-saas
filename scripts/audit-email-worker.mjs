...
check("Readiness exige migracion productiva vigente", server.includes("0064_attendance_daily_limit_payroll.sql") && server.includes("EMAIL_DELIVERY_WORKER_ENABLED"), "readiness");
