export const runtimeApiRoutes = [
  ...
  { method: "POST", path: "/api/attendance/cancel-entry", moduleId: "attendance", capability: "attendance.self.visual" },
  ...
  { method: "GET", path: "/api/payroll/workers", moduleId: "payroll", capability: "payroll.read" },
  { method: "PATCH", path: "/api/payroll/workers/:workerId/settings", moduleId: "payroll", capability: "payroll.manage" },
  { method: "POST", path: "/api/payroll/workers/:workerId/payments", moduleId: "payroll", capability: "payroll.manage" },
