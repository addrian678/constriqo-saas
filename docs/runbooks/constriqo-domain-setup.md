...
8. Probar login Super Admin desde `app.constriqo.com/acceso-admi-proveedor-constriqo`.
9. Probar que cookies, CORS y MFA funcionan en HTTPS.
10. Dejar `constriqo.com` para landing comercial.
...
- `app.constriqo.com/acceso-admi-proveedor-constriqo`: acceso privado proveedor; no se entrega a clientes.
