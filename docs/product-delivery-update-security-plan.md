...
5. Preparacion para produccion
   - `/ready` exige que las migraciones productivas vigentes esten aplicadas; esta fase introdujo `0051_email_delivery_worker_outbox.sql` y actualmente requiere `0064_attendance_daily_limit_payroll.sql`.
...
5. Readiness y pruebas
   - `/ready` exige la migracion productiva vigente `0064_attendance_daily_limit_payroll.sql`.
...
2. Validaciones incluidas
   ...
   - Migracion vigente `0064_attendance_daily_limit_payroll.sql`.
